...
def generate_rsvp_response(rsvp_data):
    ...
    try:
        ...
        body += f"\n\nP.S. This response came from Sullstice AI. Hopefully it was pretty good. It may have made some stuff up. No worries though, I'm cc'd on the email and read every one."
